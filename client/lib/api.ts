...
class ApiClient {
  ...
  async getActivityComments(activityId: string): Promise<{
    ...
    return this.request(`/cleanup-activities/${activityId}/comments`);
  }

  async addActivityComment(activityId: string, commentText: string): Promise<{
    comment: any;
    message: string;
  }> {
    return this.request(`/cleanup-activities/${activityId}/comments`, {
  ...
  async deleteActivityComment(commentId: string): Promise<{
    message: string;
  }> {
